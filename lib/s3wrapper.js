...
class S3wrapper {
  ...
  __listObjects ({bucket}, cb) {
    ...
    debug('_listObjects: params:', params);
    return this.s3.listObjects(params, (err, data) => {
      ...
      debug('_listObjects: SUCCESS:', keys);           // successful response
  ...
  _listNames (params, cb) { return this._listKeys; }
  ...
  listNames (params, cb) { return this.listKeys; }
  ...
  async uploadDir ({localDir, bucket}, cb) {
    ...
    const filenames = dirListFilenames(localDir, {addPath:'join'});
